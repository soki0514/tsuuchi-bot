...
# 全スレッド合計で同時にgetTransactionを呼べるのは2つまで。
# api.mainnet-beta除外後はHelius+Publicnode×2の3本構成。
# _SOLANA_RPS_LIMIT=5 と揃えることで同時RPC数がRPS制限を超えないよう制御する。
_SOLANA_SEMAPHORE = threading.Semaphore(2)
