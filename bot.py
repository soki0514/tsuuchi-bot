...
EVM_CHAINS = [
    ...
    },
    {
        ...
        # publicnode → mainnet.base.org → drpc の順
...
# 全スレッド合計で1秒間に6回までしかSolana RPCを呼べないよう制限する。
# worker×3プール+monitor+loopスレッドが同時にRPCを叩くため
# Helius無料枠(10 RPS)に対して4つのマージンを確保し429エラーを根絶する。
_SOLANA_RPS_LIMIT  = 6
